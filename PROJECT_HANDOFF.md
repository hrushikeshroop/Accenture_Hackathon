...
| D-21 | The scenario page was dominated by raw JSON. | The first view now tells the prototype story directly: scenario input, AI candidate, risk, latency, decision, reason, and checker outcomes. Route, risk signals, full checker/evidence tables, and raw JSON remain progressively disclosed. |
